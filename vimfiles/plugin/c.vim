...
"
let s:C_CplusCFlags         	= '-std=c++0x -Wall -g -O0 -c'      " C++ compiler flags: compile, don't optimize
let s:C_CplusLFlags         	= '-std=c++0x -Wall -g -O0'         " C++ compiler flags: link   , don't optimize
